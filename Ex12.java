...
public class Ex12 {
    public static void main(String[] args) {
        ...
        System.out.printf("Digite um nuremo refernte ao mês  <1 a 12>: ");
        mes = ler.nextInt();

        if (mes == 1) System.out.print("Janeiro");
        else 
        if (mes == 2) System.out.print("Feveirp");
        else 
        ...
        else          System.out.print("Numero invalido! Apenas numeros de <1 a 12>");
    }
}
